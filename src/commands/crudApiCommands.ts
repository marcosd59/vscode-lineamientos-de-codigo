...
export function registerGetApiCommand(context: vscode.ExtensionContext) {
  const insertGetApiTemplate = vscode.commands.registerCommand(
  ...
  context.subscriptions.push(insertGetApiTemplate);
}

export function registerPostApiCommand(context: vscode.ExtensionContext) {
  const insertPostApiTemplate = vscode.commands.registerCommand(
  ...
  context.subscriptions.push(insertPostApiTemplate);
}

export function registerPutApiCommand(context: vscode.ExtensionContext) {
  const insertPutApiTemplate = vscode.commands.registerCommand(
  ...
  context.subscriptions.push(insertPutApiTemplate);
}

export function registerDeleteApiCommand(context: vscode.ExtensionContext) {
  const insertDeleteApiTemplate = vscode.commands.registerCommand(
  ...
  context.subscriptions.push(insertDeleteApiTemplate);
}
